...
<script> function searchRivt(){strng1 = document.getElementById("terms");strng2 = document.getElementById("terms").value;URL = `https://github.com/search?q=rivt+${strng2}+in%3Areadme`;window.open(URL,'_self')};strng.addEventListener("keypress", function(e) {if (e.key === 13){e.preventDefault();document.getElementById("searchBtn").click();}})</script>
